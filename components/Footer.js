...
export const Footer = () => {
    return (
        <div tw="flex flex-col absolute px-10 bg-black laptop:px-[165px] h-[626px] tablet:h-[337px] laptop:h-[321px] w-full pt-16 tablet:pt-[80px] laptop:pt-[72px] gap-y-10 tablet:gap-y-0">
